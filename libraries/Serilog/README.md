...
> Demo: Example project that consume and demonstrate Serilog functionality and integration in ASP.NET/.NET Core.
...
- [Use Serilog in ASP.NET or ASP.NET Core](https://medium.com/dotnet-hub)
