# Swagger (Swashbuckle) — OpenAPI in .NET

> Demo: Example project that consume and demonstrate Swagger (Swashbuckle) functionality and integration in ASP.NET/.NET Core.
...
- [Use Swagger (Swashbuckle) — OpenAPI in ASP.NET or ASP.NET Core](https://medium.com/dotnet-hub)
